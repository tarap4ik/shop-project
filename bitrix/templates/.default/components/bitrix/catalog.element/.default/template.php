...
$arParams['MESS_PARTNERS_TAB'] = $arParams['MESS_PARTNERS_TAB'] ?: Loc::getMessage('CT_BCE_CATALOG_PARTNERS_TAB');
    ...
    <div class="bx-catalog-element bx-<?= $arParams['TEMPLATE_THEME'] ?>" id="<?= $itemIds['ID'] ?>"
                        ...
                        <div class="col-xs-12">
                            <div class="product-item-detail-tabs-container">
                                <ul class="product-item-detail-tabs-list">
                                    ...
                                    if (!empty($arResult['PROPERTIES']['PARTNER']['VALUE'])) { //Вкладка партнеры
                                        ?>
                                        <li class="product-item-detail-tab" data-entity="tab" data-value="partners">
                                            <a href="javascript:void(0);" class="product-item-detail-tab-link">
                                                <span><?= $arParams['MESS_PARTNERS_TAB'] ?></span>
                                            </a>
                                        </li>
                                        <?
                                    }?>
        ...
        <div class="product-item-detail-tabs-container-fixed hidden-xs" id="<?= $itemIds['TABS_PANEL_ID'] ?>">
            <ul class="product-item-detail-tabs-list">
                ...
                if (!empty($arResult['PROPERTIES']['PARTNER']['VALUE'])) { //Вкладка партнеры
                    ?>
                    <li class="product-item-detail-tab" data-entity="tab" data-value="partner">
                        <a href="javascript:void(0);" class="product-item-detail-tab-link">
                            <span><?= $arParams['MESS_PARTNERS_TAB'] ?></span>
                        </a>
                    </li>
